...
Design (see docs/warming-levels-data-and-next-steps.md §7.4): the writer targets the SAME
...
the 4×-bigger data forces (new grid, ~270M rows, partitioning, which stats to keep). Turning it
