...
class Dataset():
    ...
    def db_do_bulk_insert(self):
        ...
        query = """INSERT INTO pf_public.pf_climate_data (coordinates,dataset_id,data_baseline,data_1C,data_1_5C,data_2C,data_2_5C,data_3C) VALUES (ST_GeomFromText('POINT(%s %s)', 4326), %s,%s,%s,%s,%s,%s,%s)"""
